        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="rounded-lg md:space-y-2 bg-blue-100 text-lg px-4 py-2 text-left text-sm font-medium text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75">
              ...
              <p>
                <span className="font-bold">Brand Tone:</span>{" "}
                {engagement?.BrandTone}
              </p>
              <p>
                <span className="font-bold">Brand Description:</span>{" "}
                {engagement?.CompanySector}
              </p>
              <p>
            ...
            isCloseVisible ? (
              <div
                id="toast-success"
                className="flex items-center w-full p-4 mt-8 mb-4 text-gray-600 bg-gray-800 text-white rounded-lg shadow  "
                role="alert"
              >
                <ThreeDots
                  height="10"
