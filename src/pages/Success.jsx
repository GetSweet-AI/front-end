...
export default function Success() {
    ...
    const updateTokens = async () => {
        try {
            const response = await fetch('https://seashell-app-2-n2die.ondigitalocean.app/api/v1/auth/update-available-tokens/64a58d8481e0231585e5f2f0', {
                method: 'PUT',
                headers: {
    ...
    const getUserData = async () => {
        await axios.get(`https://seashell-app-2-n2die.ondigitalocean.app/api/v1/auth/users/${user?._id}`).then(() => {
        ...
        flex justify-center items-center">
                            <div className="bg-white bg-opacity-10 px-2 shadow-2xl py-5 opacity-90 md:w-[70%] lg:w-[45%] w-full rounded-xl">
                                ...
                                <div className="max-w-sm mx-auto flex flex-col justify-center items-center text-start pb-12 md:pb-10">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-check mt-6" width="140" height="140" viewBox="0 0 24 24" stroke-width="1.5" stroke="#6366F1" fill="none" stroke-linecap="round" stroke-linejoin="round">
