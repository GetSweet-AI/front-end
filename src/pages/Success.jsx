...
export default function Success() {
    ...
    const updateTokens = async () => {
        try {
            const response = await fetch('https://seal-app-dk3kg.ondigitalocean.app/api/v1/auth/update-available-tokens/64a58d8481e0231585e5f2f0', {
                method: 'PUT',
                headers: {
    ...
    const getUserData = async () => {
        await axios.get(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/auth/users/${user?._id}`).then(() => {
