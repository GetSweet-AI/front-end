          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto text-start pb-12">
                <h1 className="h4 font-cabinet-grotesk">Let’s finish this and get building</h1>
                <h1 className=" font-cabinet-grotesk">Your first bot can be running in 2 minutes </h1>
              </div>
              {/* Form */}
                ...
                <form>
                  ...
                  <label className="flex items-start">
                    ...
                    <span className="text-xs text-gray-500 ml-3">
                      Your FlowBot account is Free, you can choose to upgrade at any time.
