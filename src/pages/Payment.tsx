...
function Payment() {
  ...
  const getPlanInfos = async () => {
    ...
    setIsLoading(true);
    await axios
      .get(`https://seashell-app-2-n2die.ondigitalocean.app/api/v1/plans`)
      .then((res) => {
  ...
  const handleSwitchPlan = async () => {
    ...
    try {
      const response = await axios.post(
        "https://seashell-app-2-n2die.ondigitalocean.app/api/v1/update-subscription",
        {
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div>
              ...
              {hasSubscription && (
                <>
                  <h2 className="my-4 text-xl text-blue-500 font-bold">
                    Update plan
                  </h2>
                  <PlansCheckBox
                    selected={selected}
