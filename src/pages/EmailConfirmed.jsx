...
export default function EmailConfirmed() {
    ...
    useEffect(() => {
        const confirmationLink = `https://seashell-app-8amlb.ondigitalocean.app/api/v1/auth/users/confirm-email/${userId}`;

        axios.get(`https://seashell-app-8amlb.ondigitalocean.app/api/v1/auth/users/${userId}`).then((res) => {
