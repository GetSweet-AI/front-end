...
export default function EmailConfirmed() {
  ...
  useEffect(() => {
    const confirmationLink = `https://seashell-app-2-n2die.ondigitalocean.app/api/v1/auth/users/confirm-email/${userId}`;
              ...
              <div className="bg-white bg-opacity-10 px-2 shadow-2xl py-5 opacity-90 md:w-[70%] lg:w-[45%] w-full rounded-xl">
                <div className="max-w-sm mx-auto flex flex-col justify-center items-center text-start pb-12 md:pb-10">
                  <h1 className="h4 font-cabinet-grotesk text-[#6366F1]">
                    {" "}
                    {!showSignIn
                      ? " Please wait... Until email is confirmed"
                      : "Email has been confirmed "}
                  </h1>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="icon icon-tabler icon-tabler-circle-check mt-6"
                    width="100"
                    height="100"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
