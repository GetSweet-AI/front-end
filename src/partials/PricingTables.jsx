...
function PricingTables({ planInfos }) {
  ...
  const handleClick = async (plan) => {
    setIsLoading(true)
    const result = await axios.post("https://seal-app-dk3kg.ondigitalocean.app/api/v1/checkout",
      {
        name: user?.fullName,
        phone: '123456789',
        email: user?.email,
    ...
    //  await fetch.post(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/checkout/sk_test_51MbAZNKrjQpaXbt11BqblQtCpraeA1nV1nmEX9rIaZdBpJQlIwrjK2aijRGVmo8WH7H5unbbUL7jRjrRbVagoswv00FlFbimKp`, {
    //       payload,
    //     });
    setIsLoading(false)
  ...
  const getHasSubscription = async () => {
    await axios.get(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/has-subscription/${user?.customerId}`).then((res) => {
  ...
  const getSubscriptionStatus = async () => {
    await axios.get(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/subscriptions/customer/${user?.customerId}`)
      .then((res) => {
        axios.get(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/${res.data?.subscriptionIds[0]}/status`)
          .then((response) => {
  ...
  const cancelSubscription = async () => {
    await axios.get(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/subscriptions/customer/${user?.customerId}`)
      .then((res) => {
        axios.post(`https://seal-app-dk3kg.ondigitalocean.app/api/v1/cancel-subscription`, {
