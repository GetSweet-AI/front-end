...
function PricingTables({ planInfos }) {
  ...
  const getSubscriptionStatus = async () => {
    await axios.get(`https://seashell-app-8amlb.ondigitalocean.app/api/v1/subscriptions/customer/${user?.customerId}`)
      .then((res) => {
        axios.get(`https://seashell-app-8amlb.ondigitalocean.app/api/v1/${res.data?.subscriptionIds[0]}/status`)
          .then((response) => {
  ...
  const cancelSubscription = async () => {
    await axios.get(`https://seashell-app-8amlb.ondigitalocean.app/api/v1/subscriptions/customer/${user?.customerId}`)
      .then((res) => {
        axios.post(`https://seashell-app-8amlb.ondigitalocean.app/api/v1/cancel-subscription`, {
