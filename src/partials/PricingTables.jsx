...
function PricingTables() {
  ...
  const getHasSubscription = async () => {
    await axios
      .get(`http://localhost:5000/api/v1/has-subscription/${user?.customerId}`)
      .then((res) => {
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            <h2 className="h3 font-red-hat-display mb-4 text-gray-100">
              {hasSubscription
                ? "You already have an active subscription.   Enjoy access to premium features!"
          ...
          {hasSubscription && (
            <div className="flex justify-center">
              <div className="mb-2 rounded-md font-bold text-center z-6 text-white bg-gradient-to-r from-[#6366ff] to-[#373afd] py-3  w-1/2">
                {" "}
                <a href="https://billing.stripe.com/p/login/test_00g7vnfPXaLh6zu288">
                  Manage subscription
                </a>
              </div>
            </div>
